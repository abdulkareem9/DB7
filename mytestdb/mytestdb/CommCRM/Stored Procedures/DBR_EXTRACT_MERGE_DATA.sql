CREATE PROC [CommCRM].[DBR_EXTRACT_MERGE_DATA] @in_tablename [varchar](100) AS
...
begin
	...
	set @var_stg_tablename = 'CommCRM.DBR_STG_EXTRACT_' + @in_tablename
	...
	set @var_query = 'drop external table ' + @var_stg_tablename
