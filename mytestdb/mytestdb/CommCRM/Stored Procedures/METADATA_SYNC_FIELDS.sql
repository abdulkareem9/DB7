CREATE PROC [CommCRM].[METADATA_SYNC_FIELDS] @tablename [varchar](100) AS
...
begin
	...
	IF OBJECT_ID ('CommCRM.'+@tablename) IS NULL
	begin
		...
		set @new_table_query = 'CREATE TABLE CommCRM.' + @tablename + '('
