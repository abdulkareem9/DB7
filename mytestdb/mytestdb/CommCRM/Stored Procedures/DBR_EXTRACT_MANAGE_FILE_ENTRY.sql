CREATE PROC [CommCRM].[DBR_EXTRACT_MANAGE_FILE_ENTRY] @in_filename [varchar](1000),@in_apiname [varchar](100),@in_prcsd_flag [varchar](1),@in_sfdc_extract_count [int],@in_sql_expired_count [int],@in_sql_insert_count [int] AS
